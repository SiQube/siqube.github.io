...
export default function App() {
	...
	useEffect(() => {
		...
		for (const r of reveals) io.observe(r);
	...
	return (
		<div className="font-sans text-gray-900 antialiased">
			...
			<main className="space-y-0">
				<section
					id="about"
					className="min-h-screen snap-start flex items-center reveal-on-scroll opacity-0 transform translate-y-6 transition-all duration-700"
				>
					<About />
				</section>

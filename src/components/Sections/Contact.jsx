...
export default function Contact() {
  return (
    <div className="container mx-auto px-6 max-w-4xl">
      ...
      <p className="text-gray-700 mb-4">Email — <a className="underline" href="mailto:davidrobert.reich@uzh.ch">firstname.lastname[at]uni-potsdam.de</a></p>
      <form className="grid grid-cols-1 gap-4 max-w-xl">
        ...
        <button className="self-start px-6 py-2 rounded bg-black text-white">Send</button>
      </form>
    </div>
  )
}
